...
async value(jid, path, filename = '', caption = '', quoted = null, ptt = false, options = {}) {
  ...
  // ================= AUDIO =================
  if (mtype === 'audio') {
    if (/mp3|mpeg/i.test(mimetype)) mimetype = 'audio/mpeg'
    else if (/ogg/i.test(mimetype)) mimetype = 'audio/ogg; codecs=opus'
    else if (/m4a|mp4/i.test(mimetype)) mimetype = 'audio/mp4'

    opt.ptt = ptt || options.ptt || false
  }
